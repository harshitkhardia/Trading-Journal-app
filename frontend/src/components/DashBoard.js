        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => console.log('you have clicked on Calendar')}>Calendar</a>

              <a href="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => console.log('you have clicked on Reports')}>Reports</a>
    ...
    <div className="md:hidden" id="mobile-menu">
      ...
      <div className="border-t border-gray-700 pt-4 pb-3">
        ...
        <div className="mt-3 space-y-1 px-2">
          ...
          <a href="#" class Name="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign out</a>
        </div>
      </div>
    </div>
  </nav>
